...
export declare class ChemistsService {
    private prisma;
    constructor(prisma: PrismaService);
    getAssignedChemistIds(userId: string): Promise<string[]>;
    private withAssignedSalesPerson;
    create(dto: CreateChemistDto, addedById: string): Promise<{
        territory: {
            id: number;
            name: string;
